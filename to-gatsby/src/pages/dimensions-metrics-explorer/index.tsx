  ...
  return (
    <Layout title="Dimensions & Metrics Explorer">
      <Typography variant="body1">
        ...
        dimensions and metrics available through the{" "}
        <a href={Url.coreReporting}>Core Reporting API</a>.
      </Typography>
      ...
      <Typography variant="body1">
        <b>Identify valid combinations</b> – Not all dimensions and metrics can
        be queried together. Only certain dimensions and metrics can be used
        together to create valid combinations. Select a dimension or metric
        checkbox to see all the other values that can be combined in the same
        query.
      </Typography>
